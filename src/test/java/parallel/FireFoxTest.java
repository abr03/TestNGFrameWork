...
import org.testng.annotations.Test;
	...
	public class FireFoxTest {
		 ...
		 * offers.click(); Thread.sleep(3000); WebElement loginBtn =
		...
		/*
		 * System.out.println("The thread ID for clickOrders Firefox is "+
		 * Thread.currentThread().getId()); WebElement
		 * orders=driver.findElement(By.cssSelector("a#orders")); orders.click();
